...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BaconRevenge", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("BaconRevenge", null, 1000, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "BaconRevenge";
		app.meta["name"] = "BaconRevenge";
