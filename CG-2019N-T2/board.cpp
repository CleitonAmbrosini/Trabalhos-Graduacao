...
unit *board::units[6]; //6
vector<vector <board::placement> > board::pieces;
//board::colors board::aiSide board::currentTurn
              ...
              if (graphics::texBlend)
                {
                  ...
                  setMaterial (select); // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ cooooooooooooooooooooooooooooooorrrrrrrrrrrrrrrrrrrrrr
...
{
  GLuint nameBuff[100];
  GLint viewport[6]; // used to set clipping volume for picking
